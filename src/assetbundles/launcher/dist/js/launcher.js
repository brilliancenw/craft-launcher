    ...
    window.LauncherPlugin = {
        ...
        getIconSvg: function(iconType) {
            ...
            const iconMap = {
                ...
                'settings': '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M6.5 1.5h3l.4 1.2c.3.1.6.2.9.4l1.1-.7 2.1 2.1-.7 1.1c.2.3.3.6.4.9l1.2.4v3l-1.2.4c-.1.3-.2.6-.4.9l.7 1.1-2.1 2.1-1.1-.7c-.3.2-.6.3-.9.4l-.4 1.2h-3l-.4-1.2c-.3-.1-.6-.2-.9-.4l-1.1.7-2.1-2.1.7-1.1c-.2-.3-.3-.6-.4-.9L1.5 9.5v-3l1.2-.4c.1-.3.2-.6.4-.9l-.7-1.1 2.1-2.1 1.1.7c.3-.2.6-.3.9-.4l.4-1.2z" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linejoin="round"/><circle cx="8" cy="8" r="2.5" stroke="currentColor" stroke-width="1.5" fill="none"/></svg>',
                // Commerce icons
