    ...
    window.LauncherPlugin = {
        ...
        getIconSvg: function(iconType) {
            ...
            const iconMap = {
                ...
                'settings': '<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M15.48 5.2c.1.27 0 .57-.2.77l-1.35 1.23c.03.26.05.52.05.8s-.02.54-.05.8l1.35 1.23c.22.19.3.5.2.77-.14.37-.3.73-.5 1.07l-.15.25c-.21.35-.44.67-.69.98-.19.23-.49.3-.77.21l-1.74-.55c-.42.32-.88.59-1.38.8l-.39 1.78c-.06.28-.28.51-.57.56-.43.07-.88.11-1.33.11s-.9-.04-1.33-.11c-.29-.05-.51-.28-.57-.56l-.39-1.78c-.5-.21-.96-.48-1.38-.8L1.7 12.5c-.28.09-.58.02-.77-.21-.25-.31-.48-.63-.69-.98l-.15-.25c-.2-.34-.36-.7-.5-1.07-.1-.27-.02-.58.2-.77l1.35-1.23c-.03-.26-.05-.52-.05-.8s.02-.54.05-.8L.69 6.16c-.22-.19-.3-.5-.2-.77.14-.37.3-.73.5-1.07l.15-.25c.21-.35.44-.67.69-.98.19-.23.49-.3.77-.21l1.74.55c.42-.32.88-.59 1.38-.8l.39-1.78c.06-.28.28-.51.57-.56C7.1.24 7.55.2 8 .2s.9.04 1.33.11c.29.05.51.28.57.56l.39 1.78c.5.21.96.48 1.38.8l1.74-.55c.28-.09.58-.02.77.21.25.31.48.63.69.98l.15.25c.2.34.36.7.5 1.07zM8 10.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/></svg>',
                // Commerce icons
